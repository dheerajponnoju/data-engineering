...
- Ensure there are no data data mismatches before and after conversion.
- There should not be NULLs added, rather provide empty strings if necessary.
- Emphasize data appropriateness in each step.
